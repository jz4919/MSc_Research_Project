...
EU_HAR_in_model <- comp_har_pred(23, 256, log(EU_daily$rvol^2))$model
EU_HAR_in_model$coefficients
EU_HAR_inpred <- data.frame(date=EU_daily$date[24:257], pred=predict(EU_HAR_in_model), true=log(EU_daily$rvol[24:257]^2))
...
```{r echo=FALSE}
# Estimate the model on full data sample
EU_SHAR_in_model <- comp_shar_pred(23, 256, log(EU_daily$rvol^2), log(EU_daily$P_rvol^2), log(EU_daily$N_rvol^2))$model
EU_SHAR_in_model$coefficients
EU_SHAR_inpred <- data.frame(date=EU_daily$date[24:257], pred=predict(EU_SHAR_in_model), true=log(EU_daily$rvol[24:257]^2))
# Plot the HAR in-sample forecast
