...
EU_HAR_RVJ_in_model <- comp_har_cj_pred(23, 256, log(EU_daily4$rvar), log(EU_daily4$jump+1e-6))$model
EU_HAR_RVJ_in_model$coefficients
EU_HAR_RVJ_inpred <- data.frame(date=EU_daily$date[24:257], pred=predict(EU_HAR_RVJ_in_model), true=log(EU_daily$rvol[24:257]^2))
...
# Estimate the model on full data sample
EU_HAR_RVJ_in_model <- comp_har_rvj_trans_pred(23, 256, EU_daily2$rvar, EU_daily2$jump, log, function(x){log(x+1e-6)})$model
EU_HAR_RVJ_in_model$coefficients
base::summary(EU_HAR_RVJ_in_model)$adj.r.squared
...
```{r}
# Estimate the model on full data sample
EU_HAR_RVCJ_in_model <- comp_har_cj_pred(23, 256, log(EU_daily4$adj.c), log(EU_daily4$adj.j+1e-6))$model
EU_HAR_RVCJ_in_model$coefficients
EU_HAR_RVCJ_inpred <- data.frame(date=EU_daily$date[24:257], pred=predict(EU_HAR_RVCJ_in_model), true=log(EU_daily$rvol[24:257]^2))
...
```{r}
# Estimate the model on full data sample
EU_HAR_BVJ_in_model <- comp_har_cj_pred(23, 256, log(EU_daily4$rbpv*mu1^(-2)), log(EU_daily2$jump+1e-6))$model
EU_HAR_BVJ_in_model$coefficients
EU_HAR_BVJ_inpred <- data.frame(date=EU_daily$date[24:257], pred=predict(EU_HAR_BVJ_in_model), true=log(EU_daily$rvol[24:257]^2))
...
```{r}
# Estimate the model on full data sample
EU_SHAR_RVJ_in_model <- comp_shar_cj_pred(23, 256, log(EU_daily4$rvar), log(EU_daily4$P_rvar), log(EU_daily4$N_rvar), log(EU_daily4$jump+1e-6))$model
EU_SHAR_RVJ_in_model$coefficients
EU_SHAR_RVJ_inpred <- data.frame(date=EU_daily$date[24:257], pred=predict(EU_SHAR_RVJ_in_model), true=log(EU_daily$rvol[24:257]^2))
